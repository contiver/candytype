...
public class Level4 extends Grid {
    ...
    private static int REQUIRED_SCORE = 3500;
    private static int MAX_MOVES = 15;
    private Cell wallCell, candyGenCell;
    ...
    protected void fillGrid(){
        super.fillGrid();
            for (int col = 2; col < 7; col++) {
                g()[2][col] = new Blank(this, new BlankElement());
                getMap().put(g()[2][col], new Point(2,col));
            }
        g()[3][4] = new Blank(this, new BlankElement());
        getMap().put(g()[3][4], new Point(3,4));
    }
